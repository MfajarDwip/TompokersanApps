...
class PengajuanSuratBerpergian extends StatefulWidget {
  String idsurat;
  String namaSurat;
  Keluarga keluarga;
  Masyarakat masyarakat;
  PengajuanSuratBerpergian(
      {Key? key,
  ...
  @override
  State<PengajuanSuratBerpergian> createState() => _PengajuansuratState();
}

class _PengajuansuratState extends State<PengajuanSuratBerpergian> {
  @override
  void initState() {
  ...
  void verifypengajuan() {
    if (keperluan.text.isEmpty) {
      ...
      Fluttertoast.showToast(
          msg: "Silahkan unggah bukti pengantar anda",
          backgroundColor: black.withOpacity(0.7));
