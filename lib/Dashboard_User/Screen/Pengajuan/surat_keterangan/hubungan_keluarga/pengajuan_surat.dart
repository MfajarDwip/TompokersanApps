...
class PengajuanSuratHubunganKeluarga extends StatefulWidget {
  String idsurat;
  String namaSurat;
  Keluarga keluarga;
  Masyarakat masyarakat;
  PengajuanSuratHubunganKeluarga(
      {Key? key,
  ...
  @override
  State<PengajuanSuratHubunganKeluarga> createState() => _PengajuansuratState();
}

class _PengajuansuratState extends State<PengajuanSuratHubunganKeluarga> {
  @override
  void initState() {
  ...
  void verifypengajuan() {
    if (keperluan.text.isEmpty) {
      ...
      Fluttertoast.showToast(
          ...
          backgroundColor: black.withOpacity(0.7));
    } else if (imageAkteKelahiran == null) {
      Fluttertoast.showToast(
          msg: "Silahkan unggah fotokopi Akte kelahiran",
          backgroundColor: black.withOpacity(0.7));
    } else {
  ...
  Future getImageGalerryAkteKelahiran() async {
    final picker = ImagePicker();
    final imageFile = await picker.pickImage(source: ImageSource.gallery);
    setState(() {
      imageAkteKelahiran = File(imageFile!.path);
    });
  }
                    ...
                    child: imageAkteKelahiran == null
                        ? Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "Unggah Fotokopi Akte Kelahiran",
                                  style: MyFont.poppins(
                                      fontSize: 12, color: softgrey),
                                )
                              ],
                        ...
                        : Container(
                            ...
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(10),
                                image: DecorationImage(
                                    image: FileImage(imageAkteKelahiran!),
                                    fit: BoxFit.cover)),
                          )),
              ),
            ),
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      if (keperluan.text.isEmpty) {
                        ...
                        if (imageAkteKelahiran != null) {
                          final aktekelahiranFile =
                              await http.MultipartFile.fromPath(
                            'image_aktekelahiran',
                            imageAkteKelahiran!.path,
                            contentType: MediaType('image',
                                path.extension(imageAkteKelahiran!.path)),
                          );
                          request.files.add(aktekelahiranFile);
                        }
...
// Fungsi untuk mengunggah data dan gambar ke backend (menggunakan paket http)
  Future<void> uploadDataAndImages() async {
    ...
    if (imageAkteKelahiran != null) {
      final aktekelahiranFile = await http.MultipartFile.fromPath(
        'image_aktekelahiran',
        imageAkteKelahiran!.path,
        contentType: MediaType('image', path.extension(imageAkteKelahiran!.path)),
      );
      request.files.add(aktekelahiranFile);
    }
