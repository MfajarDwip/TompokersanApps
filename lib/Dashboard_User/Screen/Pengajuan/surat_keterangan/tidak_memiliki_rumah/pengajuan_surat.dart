...
class PengajuanSuratTidakMemilikiRumah extends StatefulWidget {
  String idsurat;
  String namaSurat;
  Keluarga keluarga;
  Masyarakat masyarakat;
  PengajuanSuratTidakMemilikiRumah(
      {Key? key,
  ...
  @override
  State<PengajuanSuratTidakMemilikiRumah> createState() => _PengajuansuratState();
}

class _PengajuansuratState extends State<PengajuanSuratTidakMemilikiRumah> {
  @override
  void initState() {
