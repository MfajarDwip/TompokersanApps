...
class PengajuanSuratKematian extends StatefulWidget {
  String idsurat;
  String namaSurat;
  Keluarga keluarga;
  Masyarakat masyarakat;
  PengajuanSuratKematian(
      {Key? key,
  ...
  @override
  State<PengajuanSuratKematian> createState() => _PengajuansuratState();
}

class _PengajuansuratState extends State<PengajuanSuratKematian> {
  @override
  void initState() {
