...
class DaftarKeluargaSuratKematian extends StatefulWidget {
  final Surat selectedSurat;
  const DaftarKeluargaSuratKematian({required this.selectedSurat, Key? key})
      : super(key: key);

  @override
  State<DaftarKeluargaSuratKematian> createState() => _DaftarKeluargaState();
}

class _DaftarKeluargaState extends State<DaftarKeluargaSuratKematian> {
                                ...
                                ListTile(
                                  onTap: () {
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => PengajuanSuratKematian(
                                            idsurat: idSurat,
                                            namaSurat: namaSurat,
                                            keluarga: data[index],
                                            masyarakat:
