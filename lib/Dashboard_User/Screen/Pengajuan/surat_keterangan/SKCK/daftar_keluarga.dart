...
class DaftarKeluargaSKCK extends StatefulWidget {
  final Surat selectedSurat;
  const DaftarKeluargaSKCK({required this.selectedSurat, Key? key})
      : super(key: key);

  @override
  State<DaftarKeluargaSKCK> createState() => _DaftarKeluargaState();
}

class _DaftarKeluargaState extends State<DaftarKeluargaSKCK> {
