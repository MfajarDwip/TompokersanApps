...
import 'package:mobile_kepuharjo_new/Dashboard_User/Screen/Pengajuan/surat_keterangan/kenal_lahir/pengajuan_surat.dart';
...
class DaftarKeluargaKenalLahir extends StatefulWidget {
  final Surat selectedSurat;
  const DaftarKeluargaKenalLahir({required this.selectedSurat, Key? key})
      : super(key: key);

  @override
  State<DaftarKeluargaKenalLahir> createState() => _DaftarKeluargaState();
}

class _DaftarKeluargaState extends State<DaftarKeluargaKenalLahir> {
                                ...
                                ListTile(
                                  onTap: () {
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => Pengajuansuratkenallahir(
                                            idsurat: idSurat,
                                            namaSurat: namaSurat,
                                            keluarga: data[index],
                                            masyarakat:
