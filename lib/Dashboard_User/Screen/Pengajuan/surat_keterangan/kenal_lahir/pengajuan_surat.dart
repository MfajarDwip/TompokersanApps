...
class Pengajuansuratkenallahir extends StatefulWidget {
  String idsurat;
  String namaSurat;
  Keluarga keluarga;
  Masyarakat masyarakat;
  Pengajuansuratkenallahir(
      {Key? key,
  ...
  @override
  State<Pengajuansuratkenallahir> createState() => _PengajuansuratState();
}

class _PengajuansuratState extends State<Pengajuansuratkenallahir> {
  @override
  void initState() {
