...
class PengajuanSuratKeringanan extends StatefulWidget {
  String idsurat;
  String namaSurat;
  Keluarga keluarga;
  Masyarakat masyarakat;
  PengajuanSuratKeringanan(
      {Key? key,
  ...
  @override
  State<PengajuanSuratKeringanan> createState() => _PengajuansuratState();
}

class _PengajuansuratState extends State<PengajuanSuratKeringanan> {
  @override
  void initState() {
