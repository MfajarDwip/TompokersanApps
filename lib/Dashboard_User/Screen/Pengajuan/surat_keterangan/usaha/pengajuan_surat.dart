...
class PengajuanSuratUsaha extends StatefulWidget {
  String idsurat;
  String namaSurat;
  Keluarga keluarga;
  ...
  @override
  State<PengajuanSuratUsaha> createState() => _PengajuansuratState();
}

class _PengajuansuratState extends State<PengajuanSuratUsaha> {
  @override
  void initState() {
