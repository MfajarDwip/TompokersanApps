...
import 'package:mobile_kepuharjo_new/Dashboard_User/Screen/Pengajuan/surat_keterangan/usaha/pengajuan_surat.dart';
...
class DaftarKeluargaSuratUsaha extends StatefulWidget {
  final Surat selectedSurat;
  const DaftarKeluargaSuratUsaha({required this.selectedSurat, Key? key})
      : super(key: key);

  @override
  State<DaftarKeluargaSuratUsaha> createState() => _DaftarKeluargaState();
}

class _DaftarKeluargaState extends State<DaftarKeluargaSuratUsaha> {
                                ...
                                ListTile(
                                  onTap: () {
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => PengajuanSuratUsaha(
                                            idsurat: idSurat,
                                            namaSurat: namaSurat,
                                            keluarga: data[index],
                                            masyarakat:
