...
class PengajuanSuratPindah extends StatefulWidget {
  String idsurat;
  String namaSurat;
  Keluarga keluarga;
  Masyarakat masyarakat;
  PengajuanSuratPindah(
      {Key? key,
  ...
  @override
  State<PengajuanSuratPindah> createState() => _PengajuansuratState();
}

class _PengajuansuratState extends State<PengajuanSuratPindah> {
  @override
  void initState() {
