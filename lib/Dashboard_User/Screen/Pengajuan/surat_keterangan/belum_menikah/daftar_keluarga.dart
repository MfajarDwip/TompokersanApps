...
import 'package:mobile_kepuharjo_new/Dashboard_User/Screen/Pengajuan/surat_keterangan/belum_menikah/pengajuan_surat.dart';
...
class DaftarKeluargaSuratBelumMenikah extends StatefulWidget {
  final Surat selectedSurat;
  const DaftarKeluargaSuratBelumMenikah({required this.selectedSurat, Key? key})
      : super(key: key);

  @override
  State<DaftarKeluargaSuratBelumMenikah> createState() => _DaftarKeluargaState();
}

class _DaftarKeluargaState extends State<DaftarKeluargaSuratBelumMenikah> {
                                ...
                                ListTile(
                                  onTap: () {
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => PengajuanSuratBelumMenikah(
                                            idsurat: idSurat,
                                            namaSurat: namaSurat,
                                            keluarga: data[index],
                                            masyarakat:
