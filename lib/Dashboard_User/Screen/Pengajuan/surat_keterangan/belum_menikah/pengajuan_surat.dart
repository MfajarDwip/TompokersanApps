...
class PengajuanSuratBelumMenikah extends StatefulWidget {
  String idsurat;
  String namaSurat;
  Keluarga keluarga;
  Masyarakat masyarakat;
  PengajuanSuratBelumMenikah(
      {Key? key,
  ...
  @override
  State<PengajuanSuratBelumMenikah> createState() => _PengajuansuratState();
}

class _PengajuansuratState extends State<PengajuanSuratBelumMenikah> {
  @override
  void initState() {
