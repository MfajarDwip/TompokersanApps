...
class PengajuanSuratTidakMampu extends StatefulWidget {
  String idsurat;
  String namaSurat;
  Keluarga keluarga;
  Masyarakat masyarakat;
  PengajuanSuratTidakMampu(
      {Key? key,
  ...
  @override
  State<PengajuanSuratTidakMampu> createState() => _PengajuansuratState();
}

class _PengajuansuratState extends State<PengajuanSuratTidakMampu> {
  @override
  void initState() {
