...
import 'package:mobile_kepuharjo_new/Dashboard_User/Screen/Pengajuan/surat_keterangan/domisili/pengajuan_surat.dart';
...
class DaftarKeluargaSuratDomisili extends StatefulWidget {
  final Surat selectedSurat;
  const DaftarKeluargaSuratDomisili({required this.selectedSurat, Key? key})
      : super(key: key);

  @override
  State<DaftarKeluargaSuratDomisili> createState() => _DaftarKeluargaState();
}

class _DaftarKeluargaState extends State<DaftarKeluargaSuratDomisili> {
                                ...
                                ListTile(
                                  onTap: () {
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => PengajuanSuratDomisili(
                                            idsurat: idSurat,
                                            namaSurat: namaSurat,
                                            keluarga: data[index],
                                            masyarakat:
