...
class PengajuanSuratDomisili extends StatefulWidget {
  String idsurat;
  String namaSurat;
  Keluarga keluarga;
  Masyarakat masyarakat;
  PengajuanSuratDomisili(
      {Key? key,
  ...
  @override
  State<PengajuanSuratDomisili> createState() => _PengajuansuratState();
}

class _PengajuansuratState extends State<PengajuanSuratDomisili> {
  @override
  void initState() {
