...
class PengajuanSuratLain extends StatefulWidget {
  String idsurat;
  String namaSurat;
  Keluarga keluarga;
  ...
  @override
  State<PengajuanSuratLain> createState() => _PengajuansuratState();
}

class _PengajuansuratState extends State<PengajuanSuratLain> {
  @override
  void initState() {
