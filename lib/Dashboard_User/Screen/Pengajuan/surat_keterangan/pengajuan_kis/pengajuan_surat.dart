...
class PengajuanSuratPengajuanKIS extends StatefulWidget {
  String idsurat;
  String namaSurat;
  Keluarga keluarga;
  Masyarakat masyarakat;
  PengajuanSuratPengajuanKIS(
      {Key? key,
  ...
  @override
  State<PengajuanSuratPengajuanKIS> createState() => _PengajuansuratState();
}

class _PengajuansuratState extends State<PengajuanSuratPengajuanKIS> {
  @override
  void initState() {
