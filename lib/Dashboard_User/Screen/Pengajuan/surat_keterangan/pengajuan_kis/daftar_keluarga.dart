...
import 'package:mobile_kepuharjo_new/Dashboard_User/Screen/Pengajuan/surat_keterangan/pengajuan_kis/pengajuan_surat.dart';
...
class DaftarKeluargaSuratPengajuanKIS extends StatefulWidget {
  final Surat selectedSurat;
  const DaftarKeluargaSuratPengajuanKIS({required this.selectedSurat, Key? key})
      : super(key: key);

  @override
  State<DaftarKeluargaSuratPengajuanKIS> createState() => _DaftarKeluargaState();
}

class _DaftarKeluargaState extends State<DaftarKeluargaSuratPengajuanKIS> {
                                ...
                                ListTile(
                                  onTap: () {
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => PengajuanSuratPengajuanKIS(
                                            idsurat: idSurat,
                                            namaSurat: namaSurat,
                                            keluarga: data[index],
                                            masyarakat:
