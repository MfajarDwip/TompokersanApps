...
class PengajuanSuratTutupJalan extends StatefulWidget {
  String idsurat;
  String namaSurat;
  Keluarga keluarga;
  Masyarakat masyarakat;
  PengajuanSuratTutupJalan(
      {Key? key,
  ...
  @override
  State<PengajuanSuratTutupJalan> createState() => _PengajuansuratState();
}

class _PengajuansuratState extends State<PengajuanSuratTutupJalan> {
  @override
  void initState() {
