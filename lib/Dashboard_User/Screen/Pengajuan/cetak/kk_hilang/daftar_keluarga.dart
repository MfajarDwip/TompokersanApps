...
class DaftarKeluargakkhilang extends StatefulWidget {
  final Surat selectedSurat;
  const DaftarKeluargakkhilang({required this.selectedSurat, Key? key})
      : super(key: key);

  @override
  State<DaftarKeluargakkhilang> createState() => _DaftarKeluargaState();
}

class _DaftarKeluargaState extends State<DaftarKeluargakkhilang> {
                                ...
                                ListTile(
                                  onTap: () {
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => Pengajuansuratkkhilang(
                                            idsurat: idSurat,
                                            namaSurat: namaSurat,
                                            keluarga: data[index],
                                            masyarakat:
