...
import 'package:mobile_kepuharjo_new/Dashboard_User/Screen/Pengajuan/cetak/akta_kelahiran/pengajuan_surat.dart';
...
class DaftarKeluargaaktalahir extends StatefulWidget {
  final Surat selectedSurat;
  const DaftarKeluargaaktalahir({required this.selectedSurat, Key? key})
      : super(key: key);

  @override
  State<DaftarKeluargaaktalahir> createState() => _DaftarKeluargaState();
}

class _DaftarKeluargaState extends State<DaftarKeluargaaktalahir> {
                                ...
                                ListTile(
                                  onTap: () {
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => Pengajuansurataktalahir(
                                            idsurat: idSurat,
                                            namaSurat: namaSurat,
                                            keluarga: data[index],
                                            masyarakat:
