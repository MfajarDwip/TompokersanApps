...
class Pengajuansuratkk extends StatefulWidget {
  String idsurat;
  String namaSurat;
  Keluarga keluarga;
  ...
  @override
  State<Pengajuansuratkk> createState() => _PengajuansuratState();
}

class _PengajuansuratState extends State<Pengajuansuratkk> {
  @override
  void initState() {
