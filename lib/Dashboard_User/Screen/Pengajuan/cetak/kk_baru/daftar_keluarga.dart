...
class DaftarKeluargakk extends StatefulWidget {
  final Surat selectedSurat;
  const DaftarKeluargakk({required this.selectedSurat, Key? key})
      : super(key: key);

  @override
  State<DaftarKeluargakk> createState() => _DaftarKeluargaState();
}

class _DaftarKeluargaState extends State<DaftarKeluargakk> {
                                ...
                                ListTile(
                                  onTap: () {
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => Pengajuansuratkk(
                                            idsurat: idSurat,
                                            namaSurat: namaSurat,
                                            keluarga: data[index],
                                            masyarakat:
