...
class Pengajuansurataktakematian extends StatefulWidget {
  String idsurat;
  String namaSurat;
  Keluarga keluarga;
  Masyarakat masyarakat;
  Pengajuansurataktakematian(
      {Key? key,
  ...
  @override
  State<Pengajuansurataktakematian> createState() => _PengajuansuratState();
}

class _PengajuansuratState extends State<Pengajuansurataktakematian> {
  @override
  void initState() {
  ...
  void verifypengajuan() {
    if (keperluan.text.isEmpty) {
      ...
      Fluttertoast.showToast(
          msg: "Silahkan unggah surat kematian dari kelurahan",
          backgroundColor: black.withOpacity(0.7));
    } else {
                        ...
                        ? Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "Unggah Surat Kematian dari kelurahan",
                                  style: MyFont.poppins(
                                      fontSize: 12, color: softgrey),
                                )
                              ],
  ...
  Future<void> uploadDataAndImages() async {
    ...
    if (imageSuratKematian != null) {
      final suratkematianFile = await http.MultipartFile.fromPath(
        'image_suratkematian',
        imageSuratKematian!.path,
        contentType: MediaType('image', path.extension(imageSuratKematian!.path)),
      );
      request.files.add(suratkematianFile);
    }
